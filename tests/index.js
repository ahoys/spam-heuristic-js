const spamDetect = require('../index');
...
exports.getSpamProbability_String = function(test) {
    const value = spamDetect.getSpamProbability('msg');
...
exports.getSpamProbability_Array = function(test) {
    const valueArr = spamDetect.getSpamProbability(['msg']);
    test.equal(valueArr.probability, 0);
    test.equal(valueArr.severity, 0);
    const valueArr2 = spamDetect.getSpamProbability(['msg', 'msg']);
